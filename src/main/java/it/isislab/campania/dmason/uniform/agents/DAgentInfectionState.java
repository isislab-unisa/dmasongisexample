...
public abstract class DAgentInfectionState extends DRemoteAgent<Double2D>{
	...
	public boolean switchToInfected(DCampaniaModel state)
	{
	...
	public boolean switchToExposed(DCampaniaModel state,Bag neighbors)
	{
		if(STATE==STATE_susceptible)
		{
			...
			{
				DAgentInfectionState ng=(DAgentInfectionState)obj;
	...
	private boolean switchToExposed(DCampaniaModel state)
	{
		STATE=STATE_exposed;
		EXPOSED_PERIOD=1;
	...
	public boolean switchToRecovered(DCampaniaModel state)
	{
