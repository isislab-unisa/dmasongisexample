 ...
 *
 */
public class DCampaniaModelWithUI extends GUIState
{
	...
	public DCampaniaModelWithUI(GeneralParam args,String topic) 
	{ 
		super(new DCampaniaModel(args,topic));
		topicPrefix=topic;
	...
	public void init(Controller controller)
	{
		...
		display = new Display2D(DCampaniaModel.WIDTH, DCampaniaModel.HEIGHT, this);
	...
	{
		DCampaniaModel world = (DCampaniaModel)state;
